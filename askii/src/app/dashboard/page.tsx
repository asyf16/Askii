...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-muted-foreground/5">
      <div className="fixed top-0 left-0 bg-background/20 backdrop-blur-sm w-full border-b border-border h-[64px] flex flex-row items-center justify-between px-12 drop-shadow-md z-20">
        ...
        <div className="flex flex-row items-center gap-4">
          ...
          <ThemeToggle className="border border-border z-10 bg-background hover:bg-muted/40" />
        </div>
      </div>

      <main className="pt-24 px-12 pb-12">
